...
\begin{itemize}
\item MoveTo(x, d) 									       						[x : R1, R2, R3 ; D: Lamp, Airlocks, Input/Output Stacks]			
\item PickupWafer(x, d)															[x : R1, R2, R3 ; D: Lamp, Airlocks, Input Stacks] 	
\item PlaceWafer(x, d) 															[x : R1, R2, R3 ; D: Lamp, Airlocks, Output Stacks]
\item OpenDoor(x) 																[x : DI1, DI2, DO1, DO2]  
\item CloseDoor(x) 																[x : DI1, DI2, DO1, DO2]
